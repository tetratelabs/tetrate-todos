...
public class TodosController {
    ...
    long _limit;
    @Value("${todos.api.upper:false}")
    private boolean _upper;

    @Value("${todos.cache:http://todos-redis:8080}")
    private String _cacheUrl;
    @Value("${todos.backend:http://todos-postgres:8080}")
    ...
    public Todo create(@RequestBody Todo todo) {
        ...
        if(_upper) obj.setTitle(obj.getTitle().toUpperCase());
